...
<div class="content read">
	<h2>pembeli</h2>
	<a href="createpembeli.php" class="create-contact">Tambah / Edit Akun pembeli</a>
	<table>
        <thead>
            <tr>
                <td>#</td>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?=$contact['role']?></td>
                <td class="actions">
                    <a href="updatepembeli.php?id=<?=$contact['id']?>" class="edit"><i class="fas fa-pen fa-xs"></i></a>
                    <a href="deletepembeli.php?id=<?=$contact['id']?>" class="trash"><i class="fas fa-trash fa-xs"></i></a>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
