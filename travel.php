...
<head>
    ...
    <title>Travel Plan | FlightPlan.</title>
...
<body>
    ...
    <div class="content">
        <img src="media/tiketpesawat.png" alt="">
        <h2>You Haven't Login Yet</h2>
        <div class="card-holder">
            <p>Log in to our best Offer <u><a href="login.php">here</a></u></p>
            <p>
                or <u><a href="register.php">Sign Up</a></u>
            </p>
        </div>
    </div>
    <footer>
